...
class FibonacciMaths(AbstractFibonacci):

    def intSqrt(self, n: int):
        """
    ...
    def isPerfectSqare(self, number: int):
        """
        ...
        return self.intSqrt(number) ** 2 == number


    def isFibonacci(self, number: int):
        """
        ...
        products = 5 * number ** 2
        return products > 4 and self.isPerfectSqare(products - 4) or self.isPerfectSqare(products + 4)

    def __contains__(self, value):
        return self.isFibonacci(value)
